    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Total Amount: Rs. <?php echo $total_price; ?></h5>

                        <form method="post" action="food_success.php" id="paymentForm">
                            ...
                            <div id="btn-pay">
                              <a href="food_success.php" name="btn_pay">Pay</a><br>
                            </div>
                        </form>
                    </div>
                </div>
