...
<section style="min-height:450px;">
    <div class="container" style="color:#8B008B;">
        ...
        <div class="row" style="color:white">
            <div class="col-md-6 mt-5 mb-5 pl-5" style="border-radius:30px;background-color:#8B008B">
            ...
            <div class="col-md-6">
                <form method="post">
                    <div class="container" style="color:#8B008B;">
                        ...
                        <button type="submit" name="btn_submit" class="btn" style="background-color:#8B008B;color:white;">Send Message</button>
                    </div>
                </form>
            </div>
        </div>
